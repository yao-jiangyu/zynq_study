...
#
# Generated by Vivado on Thu Apr 11 17:47:13 +0800 2024
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/code/zynq_pri/zynq_study/hdmi_output_picture/rtl/syn/top.cache/compile_simlib/activehdl"
  fi
