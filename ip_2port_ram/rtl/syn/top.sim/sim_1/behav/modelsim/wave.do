...
add wave -noupdate /tb_ip_2port_ram/sys_clk
add wave -noupdate /tb_ip_2port_ram/sys_rst_n
...
WaveRestoreCursors {{Cursor 1} {888860 ps} 0}
...
update
WaveRestoreZoom {17980792597 ps} {17982155292 ps}
