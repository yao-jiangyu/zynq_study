...
HD_PWD='C:/code/zynq_pri/zynq_study/DDS_test/rtl/syn/DDS_test/DDS_test.runs/rom_triangular_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_triangular.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_triangular.tcl
