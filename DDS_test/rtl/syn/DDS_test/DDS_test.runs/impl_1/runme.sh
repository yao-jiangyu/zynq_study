...
HD_PWD='C:/code/zynq_pri/zynq_study/DDS_test/rtl/syn/DDS_test/DDS_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_test.tcl -notrace
