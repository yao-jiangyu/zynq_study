...
HD_PWD='C:/code/zynq_pri/zynq_study/DDS_test/rtl/syn/DDS_test/DDS_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_test.tcl
