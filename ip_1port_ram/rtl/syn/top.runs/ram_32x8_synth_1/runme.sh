...
HD_PWD='C:/code/zynq_pri/zynq_study/ip_1port_ram/rtl/syn/top.runs/ram_32x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_32x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_32x8.tcl
